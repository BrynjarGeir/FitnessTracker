...
const routes = [
  {
    ...
    children: [
      ...
      { path: 'Metrics/Legs/StiffDeadlift', component: () => import('pages/Metrics/Legs/StiffDeadlift.vue'), meta: {requiresAuth: true} },
      { path: 'Metrics/Legs/KettlebellSquat', component: () => import('pages/Metrics/Legs/KettlebellSquat.vue'), meta: {requiresAuth: true} },
      { path: 'Metrics/Legs/LungeWPlate', component: () => import('pages/Metrics/Legs/LungeWPlate.vue'), meta: {requiresAuth: true} },
      { path: 'Metrics/Legs/MachineCalfPress', component: () => import('pages/Metrics/Legs/MachineCalfPress.vue'), meta: {requiresAuth: true} },
      { path: 'Metrics/Lega/MachineLegPress', component: () => import('pages/Metrics/Legs/MachineLegPress.vue'), meta: {requiresAuth: true} },
      ...
      { path: 'Metrics/Biceps/EZBarbellCurl', component: () => import('pages/Metrics/Biceps/EZBarbellCurl.vue'), meta: {requiresAuth: true} },
