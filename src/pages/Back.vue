<template>
  <q-page class="q-pa-lg">
    ...
    <div class='row'><div class='col'><q-input type="number" placeholder="Weight of exercise" v-model="w24"/></div><div class='col'><q-input type="number" placeholder="Number of iterations" v-model="n24"/></div></div> <br>
    ...
    <div class='row'><div class='col'><q-input type="number" placeholder="Weight of exercise" v-model="w33"/></div><div class='col'><q-input type="number" placeholder="Number of iterations" v-model="n33"/></div></div> <br>
    ...
    <q-input type="number" placeholder="Number of iterations" v-model="n43"/> <br>
    ...
    <div class='row'><div class='col'><q-input type="number" placeholder="Weight of exercise" v-model="w53"/></div><div class='col'><q-input type="number" placeholder="Number of iterations" v-model="n53"/></div></div> <br>
    ...
    <div class='row'><div class='col'><q-input type="number" placeholder="Weight of exercise" v-model="w63"/></div><div class='col'><q-input type="number" placeholder="Number of iterations" v-model="n63"/></div></div> <br>
    ...
    <div class='row'><div class='col'><q-input type="number" placeholder="Weight of exercise" v-model="w73"/></div><div class='col'><q-input type="number" placeholder="Number of iterations" v-model="n73"/></div></div> <br>
    ...
    <div class='row'><div class='col'><q-input type="number" placeholder="Weight of exercise" v-model="w83"/></div><div class='col'><q-input type="number" placeholder="Number of iterations" v-model="n83"/></div></div> <br>
    ...
    <q-input type="number" placeholder="Number of iterations" v-model="n93"/> <br>
    ...
    <div class='row'><div class='col'><q-input type="number" placeholder="Weight of exercise" v-model="w104"/></div><div class='col'><q-input type="number" placeholder="Number of iterations" v-model="n104"/></div></div> <br>
...
export default defineComponent({
  ...
  data() {
    return {
      ...
      w101: null, w102: null, w103: null, w104: null,
      ...
      n101: null, n102: null, n103: null, n104: null
    }
  },
  ...
  methods: {
    ...
    async ex10() {
      ...
      await setDoc(doc(db, 'fitnesstracker/' + userID + '/back', 'Standing-Row' + Date.now()), {
        name: 'Standing Row',
        weight: [parseFloat(this.w101), parseFloat(this.w102), parseFloat(this.w103), parseFloat(this.w104)],
        iterations: [parseInt(this.n101), parseInt(this.n102), parseInt(this.n103), parseInt(this.n104)],
        date: Date.now()
      }).then(
        this.w101 = null, this.w102 = null, this.w103 = null, this.w104 = null,
        this.n101 = null, this.n102 = null, this.n103 = null, this.n104 = null
      )
    }              
  }
})
